...
export default class BusinessGlobalProfile extends React.Component {
    ...
    saveData(){
        Pref.getVal(Pref.bData, valuex => {
            ...
            this.setState({ firstName: mergr.name, lastName: mergr.description, mobileNo: mergr.phone, add1: mergr.websiteUrl, address: mergr.email, cat: mergr.category })
        })
    }
    ...
    onSaveClick = () => {
        Pref.getVal(Pref.bId, vlx => {
            ...
            if (vlx !== undefined && vlx !== '') {
                ...
                Helper.networkHelperTokenPost(Pref.UpdateBusiness + vlx, jsonData, Pref.methodPost, this.state.token, result => {
