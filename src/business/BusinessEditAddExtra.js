            ...
            Alert.alert('התנתקות', 'האם אתה בטוח?', [
              ...
              },
              {
                ...
                onPress: () => {
                  ...
                  const postData = [];
                  postData.push({
                    first_int: datass.fkidbusiness,
                    second_int: datass.idextra,
                  });
                  Helper.networkHelperTokenPost(
                    Pref.DeleteExtraUrl,
      ...
      <Row
        ...
        <View
          ...
          <View
            ...
            />
            <TouchableWithoutFeedback
              onPress={() => this.deleteExtras(index, rowData)}>
              <Image
        ...
        <Screen style={styles.maincontainer}>
            ...
            leftComponent={
              <View style={{marginStart: 12}}>
                <Heading
                  ...
                  {this.state.extraMode ? 'עדכון' : 'תוספת חדשה'}
                </Heading>
              </View>
            }
          />
          <View styleName="vertical" style={{flex: 1}}>
            <ScrollView
              ...
              <View
                ...
                <Subtitle
                  ...
                  {!this.state.extraMode
                    ? 'שם קטגורית התוספת'
                    : Lodash.capitalize(this.state.extraName)}
                </Subtitle>
                  ...
                  <View>
                    ...
                    <View
                      ...
                      <Subtitle
                        ...
                        {this.state.maxSelect === 0
                          ? `אין הגבלה`
                          : this.state.maxSelect}
                      </Subtitle>
                    </View>
                  </View>
                ) : null}
                ...
                {!this.state.extraMode ? (
                  <View styleName="horizontal v-start h-start sm-gutter">
                    <Checkbox.Android
                      uncheckedColor={'#dedede'}
                      status={
                        this.state.extraSingle === 1 ? 'checked' : 'unchecked'
                      }
                      color={'#3DACCF'}
                    />
                    <Subtitle
                ...
                <View style={{marginTop: sizeHeight(1)}}>
                  ...
                  <View
                    styleName="horizontal sm-gutter"
                    onLayout={event => this.inlayout(event)}
                    ref={ref => {
                      this.inputRef = ref;
                    }}>
                    <TextInput
                    ...
                    <TextInput
                      style={[
                        styles.inputStyle,
                        {flex: 1, marginStart: sizeWidth(1)},
                      ]}
                      mode={'flat'}
                      label={'מחיר'}
                      password={false}
            ...
            <Button
              ...
              onPress={() =>
                !this.state.extraMode ? this.addExtra() : this.updateExtras()
              }>
              <Subtitle style={{color: 'white'}}>
                {this.state.extraMode === false ? 'סיום' : 'עדכון נוסף'}
              </Subtitle>
            </Button>
          </View>
            ...
            <Modal
              ...
              <View
                ...
                <TextInput
                  ...
                  onChangeText={text => this.setState({extraNameOptd: text})}
                  underlineColor={'transparent'}
                  underlineColorAndroid={'transparent'}
                />
                <TextInput
