...
import { FlatList, StatusBar, StyleSheet, TouchableWithoutFeedback} from "react-native";
import Icon from "react-native-vector-icons/MaterialIcons";
import { Divider, Heading, NavigationBar, Row, Screen, Subtitle, TouchableOpacity, View,Image } from "@shoutem/ui";
import { Button, Checkbox, Colors, Dialog, FAB, Portal, Snackbar, TextInput } from "react-native-paper";
        ...
        <Row>
          ...
          <TouchableWithoutFeedback onPress={() => {
            ...
            <Image
             ...
             style={{width:14, height:17,marginStart:sizeWidth(4),alignSelf:'center'}}
            />
  ...
  render() {
    return (
      ...
      >
        ...
        <Subtitle  style={{ color:'#292929', fontSize:16,marginTop:sizeHeight(1),marginHorizontal:sizeWidth(2)}}>שם קטגורית התוספת</Subtitle>

          <TouchableWithoutFeedback onPress={() => this.setState({ showCat: true })}>
            <View
              ...
              <Subtitle style={{ color: '#292929', fontSize: 14, alignSelf: 'flex-start',marginHorizontal:sizeWidth(2) }}>{this.state.extraName !== ""
                ? ":  " + this.state.extraName
                : "Select Extra Cat"}</Subtitle>
            </View>
          </TouchableWithoutFeedback>
          ...
          <TouchableWithoutFeedback onPress={() => this.setState({
            ...
            <View
              style={{ alignItem: 'flex-start', justifyContent: 'center', borderColor: '#dedede', borderStyle: 'solid', borderWidth: 1, color: '#000000', height: 60, marginHorizontal: sizeWidth(1), }}>
              <Subtitle style={{ color: '#292929', fontSize: 14, alignSelf: 'flex-start', marginHorizontal: sizeWidth(2) }}>               Add Extra Option</Subtitle>
            </View>
          </TouchableWithoutFeedback>
          {this.state.hideView === true ? (
            <View style={{marginTop:sizeHeight(1)}}>
              ...
              <TextInput
                style={[styles.inputStyle,{marginEnd:sizeWidth(1.5),flex:1,}]}
                mode={"flat"}
              ...
              <TouchableWithoutFeedback onPress={() => this.addExtraOptions()}>
                <View
                  style={{ alignItem: 'flex-start', justifyContent: 'center', borderColor: '#dedede', borderStyle: 'solid', borderWidth: 1, color: '#000000', height: 60, marginHorizontal: sizeWidth(1),marginTop:sizeHeight(1) }}>
                  <Subtitle style={{ color: '#292929', fontSize: 14, alignSelf: 'flex-start', marginHorizontal: sizeWidth(2) }}>               Add</Subtitle>
                </View>
              </TouchableWithoutFeedback>
            </View>
          ) : null}
