      ...
      <View
        ...
        <TouchableWithoutFeedback
          onPress={() => {
            this.setState({
              selectExtracat: true,
              selectedCategoryName: rowData.name,
              selectedCategoryItems: rowData.data,
            });
          }}>
          <Row
            style={{
          ...
          <View
            ...
            <View styleName="horizontal">
              <Checkbox.Android
                ...
                color={'#3daccf'}
                onPress={() =>
                  this.extraAllSelectItemlols(2, rowData.extra.name)
                }
              />
              <Subtitle
                styleName="bold"
      ...
      <View>
        ...
        <View styleName="vertical">
          <View
            ...
            <TouchableWithoutFeedback
              onPress={() =>
                this.expandlisterner(rowData.title, rowData.checked)
              }>
              <Icon
                style={{alignSelf: 'flex-end'}}
                name={
                  !rowData.checked ? 'keyboard-arrow-down' : 'keyboard-arrow-up'
                }
                size={24}
              />
            </TouchableWithoutFeedback>
        ...
        {this.state.allData.length - 1 === index ? (
          <View
            style={{
              height: 1,
              backgroundColor: '#dedede',
    ...
    return (
      <SafeAreaView style={styles.maincontainer} forceInset={{top: 'never'}}>
        <Screen style={styles.maincontainer}>
          ...
          {this.state.isCatgegoryClicked == 1 ? (
            <View
              ...
              <DummyLoader
                ...
                center={
                  this.state.extrasList !== null &&
                  this.state.extrasList !== undefined ? (
                    <FlatList
                      extraData={this.state}
          ...
          {this.state.isCatgegoryClicked == 2 ? (
                ...
                <Dialog.Content>
                  <View styleName="vertical sm-gutter">
                    <TextInput
                      ...
                      onChangeText={text => this.setState({extraName: text})}
                      underlineColor={'transparent'}
                      underlineColorAndroid={'transparent'}
                    />
