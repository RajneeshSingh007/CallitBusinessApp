...
export default class BusinessDelivery extends React.Component {
    ...
    if (datass.new) {
      ...
      this.setState({showdeletex: true}, () => {
        if (this.state.showdeletex) {
          Alert.alert('מחיקה', 'האם אתה בטוח?', [
            {
              text: 'לא',
              onPress: () => {
  ...
  temprow = rowData => {
    ...
    this.setState({
      extraNameOpt: rowData.name,
      tempinputdata: temppp,
      suggestionsListCities: [],
    });
  };
    ...
    return (
      <Row
        ...
        <View styleName="horizontal space-between" style={{width: '100%'}}>
          <Subtitle
            numberOfLines={1}
            style={{color: '#292929', fontSize: 16, fontWeight: 'bold'}}>
            {}
          </Subtitle>
          <TouchableWithoutFeedback
        ...
        <Screen style={styles.maincontainer}>
          ...
          <View styleName="vertical" style={{flex: 1}}>
                ...
                <ScrollView
                  ...
                  <View
                    ...
                    <View style={{marginTop: sizeHeight(1)}}>
                      ...
                      {this.state.suggestionsListCities.length > 0 ? (
                        <FlatList
                          extraData={this.state}
            ...
            <Button
              ...
              <Subtitle style={{color: 'white'}}>{'עדכון'}</Subtitle>
            </Button>
          </View>
